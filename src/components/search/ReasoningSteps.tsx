...
export const ReasoningSteps: React.FC<ReasoningStepsProps> = ({ compact = false }) => {
      ...
      <div className="relative">
        ...
        >
          ...
          <span className="text-white text-sm">
            Thinking Process
            {isComplete && (
              <span className="text-[#1DB954]/90 ml-1">• Complete</span>
            )}
          </span>
          {isExpanded ? (
        ...
        {isExpanded && (
          <div className="absolute top-full right-0 mt-2 w-72 bg-[#282828] rounded-lg shadow-xl overflow-hidden z-50">
